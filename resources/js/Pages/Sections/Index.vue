<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">Sections</h1>
    ...
    <div class="bg-white rounded shadow overflow-x-auto">
      <table class="w-full whitespace-no-wrap">
        ...
        <tr v-for="section in sections.data" :key="section.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          <td class="border-t">
            <inertia-link class="px-6 py-4 flex items-center focus:text-indigo-500" :href="route('sections.edit', section.id)">
              {{ section.name }}
